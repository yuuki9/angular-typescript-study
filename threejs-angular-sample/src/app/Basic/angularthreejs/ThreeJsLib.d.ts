export * from './Class/CameraControlClass';
export * from './Class/GISControlClass';
export * from './Class/LightControlClass';
export * from './Class/ObjectControlClass';
...
export interface IObjectClickEvent {
    object: THREE.Object3D;
    point: THREE.Vector3;
}
export declare class ThreeJSLib {
    AnimateEvent: Subject<void>;
    AddLayerEvent: Subject<ThreeLayer>;
    AddObjectEvent: Subject<IObjectEvent>;
    AddPOIEvent: Subject<IObjectEvent>;
    AddLineEvent: Subject<IObjectEvent>;
    AddPolygonEvent: Subject<IObjectEvent>;
    ClickObjectEvent: Subject<IObjectClickEvent>;
