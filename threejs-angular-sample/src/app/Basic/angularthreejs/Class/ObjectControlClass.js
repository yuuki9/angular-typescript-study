...
class ObjectControlClass {
        ...
        if (targetLayer != undefined) {
            ...
            if (targetObj != undefined)
                ...
                if (tempThreeJsLib.AddObjectEvent != undefined)
                    tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: plane }); //오브젝트가 생긴것을 이벤트 처리
            }
        }
        else {
            //신규레이어생성
     ...
     */
    Add3DS(layerName, objName, clickable = false, position, rotate, size, filePath = 'assets/resources/models/3DS/robot/ROBOT.3ds', txturePath = 'assets/resources/models/3DS/robot/ROBOT.jpg', minViewDistance = 0.1, maxViewDistance = 500, returnObj) {
        ...
        loader.load(filePath, (objects) => {
            ...
            if (targetLayer != undefined) {
                ...
                if (targetObj != undefined)
                    ...
                    if (tempThreeJsLib.AddObjectEvent != undefined)
                        tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: objects }); //오브젝트가 생긴것을 이벤트 처리
                }
            }
            else {
                //신규레이어생성
        ...
        leader.load(filePath, (geometry) => {
            ...
            if (targetLayer != undefined) {
                ...
                if (targetObj != undefined)
                    ...
                    if (tempThreeJsLib.AddObjectEvent != undefined)
                        tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: meshObj }); //오브젝트가 생긴것을 이벤트 처리
                }
            }
            else {
                //신규레이어생성
        ...
        leader.load(filePath, (points) => {
            ...
            if (targetLayer != undefined) {
                ...
                if (targetObj != undefined)
                    ...
                    if (tempThreeJsLib.AddObjectEvent != undefined)
                        tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: points }); //오브젝트가 생긴것을 이벤트 처리
                }
            }
            else {
                //신규레이어생성
        ...
        loader.load(filePath, function (geometry) {
            ...
            if (targetLayer != undefined) {
                ...
                if (targetObj != undefined)
                    ...
                    if (tempThreeJsLib.AddObjectEvent != undefined)
                        tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: newMesh }); //오브젝트가 생긴것을 이벤트 처리
                }
            }
            else {
                //신규레이어생성
    ...
    AddTexture(layerName, objName, position, size, texturePath, clickable = false) {
        ...
        if (targetLayer != undefined) {
            ...
            if (tempThreeJsLib.IsExistLayerInObjectName(layerName, objName)) {
                ...
                if (tempThreeJsLib.AddObjectEvent != undefined)
                    tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: textureMesh }); //오브젝트가 생긴것을 이벤트 처리
            }
        }
        else {
            //신규레이어생성
    ...
    AddLineToBox(layerName, objName, stPoint, edPoint, thick, height, color, opacity = 1, clickable = false) {
        ...
        if (targetLayer != undefined) {
            ...
            if (tempThreeJsLib.IsExistLayerInObjectName(layerName, objName)) {
                ...
                if (tempThreeJsLib.AddObjectEvent != undefined)
                    tempThreeJsLib.AddObjectEvent.next({ objectName: objName, object: boxMesh }); //오브젝트가 생긴것을 이벤트 처리
            }
        }
        else {
            //신규레이어생성
