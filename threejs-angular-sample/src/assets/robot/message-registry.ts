...
import {KepcoConnect} from './messages/kepco-connect';
import {KepcoDisconnect} from './messages/kepco-disconnect';
import {KepcoStateRobotPosVel} from './messages/kepco-state-robot-pos-vel';
import {KepcoStateRobotBattery} from './messages/kepco-state-robot-battery';
import {KepcoStateDronePosVel} from './messages/kepco-state-drone-pos-vel';
import {KepcoStateDroneAttitude} from './messages/kepco-state-drone-attitude';
import {KepcoStateDroneBattery} from './messages/kepco-state-drone-battery';
import {KepcoInfoWaypointStart} from './messages/kepco-info-waypoint-start';
import {KepcoInfoWaypoint} from './messages/kepco-info-waypoint';
import {KepcoInfoWaypointEnd} from './messages/kepco-info-waypoint-end';
import {KepcoCmdMission} from './messages/kepco-cmd-mission';
import {KepcoCmdSetSpeed} from './messages/kepco-cmd-set-speed';
import {KepcoStateFinalWaypointRemainDistance} from './messages/kepco-state-final-waypoint-remain-distance';
import {KepcoInfoTargetWaypointIndex} from './messages/kepco-info-target-waypoint-index';
import {KepcoCmdManualControl} from './messages/kepco-cmd-manual-control';
import {KepcoCmdRequestVideo} from './messages/kepco-cmd-request-video';
import {KepcoCmdManualMode} from './messages/kepco-cmd-manual-mode';
import {KepcoInfoOperationMode} from './messages/kepco-info-operation-mode';
import {KepcoStateCurrentWaypointRemainDistance} from './messages/kepco-state-current-waypoint-remain-distance';
import {KepcoInfoMissionComplete} from './messages/kepco-info-mission-complete';
import {KepcoInfoMissionDistance} from './messages/kepco-info-mission-distance';
import {KepcoCmdStopVideo} from './messages/kepco-cmd-stop-video';
import {KepcoRequestOperationMode} from './messages/kepco-request-operation-mode';
import {KepcoRequestMissionState} from './messages/kepco-request-mission-state';
import {KepcoInfoMissionState} from './messages/kepco-info-mission-state';
...
export const messageRegistry: Array<[number, new (system_id: number, component_id: number) => MAVLinkMessage]> = [
	[59001, KepcoConnect],
	[59002, KepcoDisconnect],
	[50000, KepcoStateRobotPosVel],
	[50001, KepcoStateRobotBattery],
	[50002, KepcoStateDronePosVel],
	[50003, KepcoStateDroneAttitude],
	[50004, KepcoStateDroneBattery],
	[51000, KepcoInfoWaypointStart],
	[51001, KepcoInfoWaypoint],
	[51002, KepcoInfoWaypointEnd],
	[51003, KepcoCmdMission],
	[51004, KepcoCmdSetSpeed],
	[51005, KepcoStateFinalWaypointRemainDistance],
	[51006, KepcoInfoTargetWaypointIndex],
	[51007, KepcoCmdManualControl],
	[51008, KepcoCmdRequestVideo],
	[51009, KepcoCmdManualMode],
	[51010, KepcoInfoOperationMode],
	[51011, KepcoStateCurrentWaypointRemainDistance],
	[51012, KepcoInfoMissionComplete],
	[51013, KepcoInfoMissionDistance],
	[51014, KepcoCmdStopVideo],
	[51015, KepcoRequestOperationMode],
	[51016, KepcoRequestMissionState],
	[51017, KepcoInfoMissionState],
	[1, SysStatus],
	[2, SystemTime],
	[4, Ping],
